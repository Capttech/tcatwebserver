...
// // import { deleteQuestionBankQuestion, updateQuestionBankQuestion } from '@/app/lib/questionBankDb';
...
// export async function PUT(_req: Request, { params }: { params: { questionId: string } }) {
...
//     //     }
//     //     const question = await updateQuestionBankQuestion(parsedQuestionId, payload);
//     //     if (!question) {
...
//     //     return NextResponse.json({ ok: false, error: 'Invalid question id.' }, { status: 400 });
//     // }
//     // const deleted = await deleteQuestionBankQuestion(parsedQuestionId);
//     // if (!deleted) {
//     //     return NextResponse.json({ ok: false, error: 'Question not found.' }, { status: 404 });
//     // }
